...
/// @param  Implode
function scr_sprite_explode(argument0, argument1, argument2, argument3, argument4, argument5, argument6, argument7, argument8, argument9, argument10, argument11, argument12) {
	...
	*/
	...
	for (i = 0; i < ww; i += argument4) {
	    for (j = 0; j < hh; j += argument4) {
	        particle = instance_create_depth((x - xoff) + i, (y - yoff) + j, -1, obj_demo_particle);  // Create the particle
